...
import PresidentMessageScreen from './screens/PresidentMessageScreen';
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen name="PresidentMessage" component={PresidentMessageScreen} />
